...
What is a RAID Log?
RAID = Risks (future threats), Actions (commitments with owners), Issues (current problems), Decisions (what was agreed). A formal PMO governance artifact. Decisions (D) prevent disputes: "I thought we decided X."
...
Meeting Intelligence — RAID extraction, JIRA updates (PRIMARY)

Status Reports & Scorecards — synthesis and generation

Strategic Resourcing — proactive gap detection and matching

Personal Task Management — email intelligence and reminders
...
Extraction confidence (avg)	≥0.85	<0.75	<0.65
